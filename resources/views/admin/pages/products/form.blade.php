...
<form method="POST" action="{{ $action }}" id="productForm" novalidate>
    ...
    {{-- Hidden active field — toggled by JS --}}
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                               ...
                               placeholder="e.g. Laboratory Information Management System (LIMS)"
                               required autofocus
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="text" id="icon" name="icon"
                                       value="{{ old('icon', $isEdit ? $product->icon : '') }}"
                                       placeholder="📦"
                                       maxlength="10"
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="meta_title" name="meta_title"
                               ...
                               placeholder="Leave blank to use module name"
                               maxlength="70"
                               class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm
                    ...
                    <div>
                        ...
                        <select id="category" name="category" required
                            ...
                            @foreach(\App\Models\Product::CATEGORIES as $catKey => $catLabel)
                                <option value="{{ $catKey }}"
                                    @selected(old('category', $isEdit ? $product->category : '') === $catKey)>
                                    {{ $catLabel }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select id="tag" name="tag"
                            ...
                            @foreach(['HIS-Related', 'Custom Dev', 'Support', 'Advisory'] as $tagOption)
                                <option value="{{ $tagOption }}"
                                    @selected(old('tag', $isEdit ? $product->tag : '') === $tagOption)>
                                    {{ $tagOption }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                ...
                <div class="p-5">
                    ...
                    <p class="mt-2 text-[10px] font-body text-gray-400 leading-relaxed">
                        Leave blank — it is auto-generated as <code class="bg-gray-100 px-1 rounded">/products/{slug}</code>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-2xl overflow-hidden">
                ...
                <div class="p-5">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        ...
                        <p id="previewTagline"
                           class="font-body text-xs text-gray-500 italic mb-3 leading-relaxed">
                            "{{ old('tagline', $isEdit ? $product->tagline : 'Tagline will appear here') }}"
                        </p>
                        <div id="previewFeatures" class="space-y-1">
                            @foreach(array_slice(old('features', $isEdit ? ($product->features ?? []) : []), 0, 3) as $f)
                                @if($f)
                                    <div class="flex items-center gap-1.5 text-[10px] text-gray-500">
                                        <svg class="w-2.5 h-2.5 text-crimson-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
