{{--
    ADMIN LOGIN PAGE
    ─────────────────────────────────────────────────────────────────
    Standalone — does NOT extend layouts.app (public layout).
    Uses the same fonts (Syne + DM Sans) and color tokens as the site.
    Route: GET /admin/login   → AdminAuthController::showLogin()
...
<div class="flex h-full min-h-screen">
    ...
    {{-- ══════════════════════════════════════════
        LEFT PANEL — Black, brand messaging
    ══════════════════════════════════════════ --}}
    <div class="hidden lg:flex lg:w-[45%] xl:w-[42%] login-panel-left login-grid flex-col justify-between p-12 xl:p-16 relative z-0">
    ...
    ══════════════════════════════════════════ --}}
    <div class="flex-1 flex flex-col justify-center items-center px-6 py-12 lg:px-16 xl:px-24 bg-white relative">
